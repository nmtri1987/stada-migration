        ...
        <tbody>
            <tr>
                ...
                <td class="ms-formbody" valign="top" colspan="2">
                    <span dir="none">
                        <asp:TextBox ID="txtTitle" runat="server" CssClass="ms-long" MaxLength="255" />
                        <br>
                    </span>
...
<link type="text/css" rel="stylesheet" href="/styles/libs/jsGrid/jsgrid.theme-bundle.min.css" />
<link type="text/css" rel="stylesheet" href="/styles/css/RequestModule/RequestsForm.min.css?v=CD44ED56-260A-4C8D-A2FE-A3A3FB20FE5C" />
<link type="text/css" rel="stylesheet" href="/styles/libs/select2/select2.min.css" />
<script type="text/javascript" src="/styles/libs/jsGrid/jsgrid.min.js?v=4BFD9342-D0FF-4E8D-8733-71E858DC7F62"></script>
<%--<script type="text/javascript" src="/styles/libs/toaster/jquery.toaster.js"></script>--%>
<script type="text/javascript" src="/styles/libs/select2/select2.min.js"></script>
<%--<script type="text/javascript" src="/styles/scripts/RequestModule/RequestForm.js?v=<%= DateTime.Now.Millisecond %>"></script>--%>
<script type="text/javascript" src="/styles/scripts/RequestModule/RequestForm.min.js?v=CD44ED56-260A-4C8D-A2FE-A3A3FB20FE5C"></script>
    ...
    $(document).ready(function () {
        var settings = {
            Controls:
            {
                ...
                SupportingDocumentDeletedItemSelector: '.supporting-item-deleted'
            },
            Messages:
            {
