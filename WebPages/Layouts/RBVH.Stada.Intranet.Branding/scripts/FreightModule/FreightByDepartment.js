    ...
    PopulateComboboxes: function () {
        ...
        $.ajax({
            ...
            success: function (result) {
                $(that.Settings.DepartmentControlSelector).append($("<option>").attr('value', "0").text(Functions.getDisplayTextOfItemAll(_spPageContextInfo.currentLanguage)));
        ...
        $.ajax({
            ...
            async: false,
            success: function (result) {
                $(that.Settings.VehicleControlSelector).append($("<option>").attr('value', "0").text(Functions.getDisplayTextOfItemAll(_spPageContextInfo.currentLanguage)));
