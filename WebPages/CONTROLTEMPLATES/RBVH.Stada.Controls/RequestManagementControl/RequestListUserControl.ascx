...
<%--                                                <a id="linkView" href="javascript:void(0);" runat="server" visible="true" target="_blank">
                                                ...
                                                <a id="linkView" runat="server" visible="true" target="_blank" style="cursor: pointer;">
                                                    <asp:Literal runat="server" Text="<%$Resources:RBVHStadaWebpages,GridViewItem_ViewDetail%>" />
                                                </a>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        ...
                                        <asp:TemplateField HeaderText="<%$Resources:RBVHStadaLists,Approval_CommonDepartment%>">
                                            <ItemTemplate>
...
<link type="text/css" rel="stylesheet" href="/styles/css/Common/BaseListPage.min.css?v=CD44ED56-260A-4C8D-A2FE-A3A3FB20FE5C" />
<script type="text/javascript" src="/styles/libs/Bootstrap/DatePicker/js/bootstrap-datepicker.min.js"></script>
<script type="text/javascript" src="/styles/libs/URI/URI.min.js?v=CD44ED56-260A-4C8D-A2FE-A3A3FB20FE5C"></script>
<script type="text/javascript" src="/styles/scripts/RequestModule/RequestList.min.js?v=CD44ED56-260A-4C8D-A2FE-A3A3FB20FE5C"></script>
