(function () {
    ...
    function CustomItemNotOvertimeRequest(ctx) {
        ...
        tr = "<tr>" + Requester + HoursPerDay + date + From + To + Reason + Comment + statusVal + viewDetail + action + "</tr>";
        return tr;
    }
    ...
    function updateListItemNotOvertimeRequest(itemId, element) {
        ...
        clientContext.executeQueryAsync(Function.createDelegate(this, function () {
            ...
            if (currentArrovalStatus && currentArrovalStatus.toLowerCase() === "approved") {
                alert(NotOvertimeViewRequestConfig.RequestStatusApproved);
                location.reload();
            }
            else if (currentArrovalStatus && currentArrovalStatus.toLowerCase() === "cancelled") {
                alert(NotOvertimeViewRequestConfig.RequestStatusCancelled);
                location.reload();
            }
            else if (currentArrovalStatus && currentArrovalStatus.toLowerCase() === "rejected") {
