...
<script language="CS" runat="server" visible="false">
    ...
    void Page_Load(object sender, System.EventArgs e)
    {
        ...
        if(string.IsNullOrEmpty(requesterLookupId) || string.IsNullOrEmpty(overtimeManagementId))
        {
            ...
            SPUtility.Redirect(string.Format("{0}{1}", webUrl,  RBVH.Stada.Intranet.Biz.Constants.StringConstant.SitePageOvertimeManagementURL), SPRedirectFlags.DoNotEndResponse | SPRedirectFlags.Trusted, HttpContext.Current);
        }
    ...
    <WebPartPages:WebPartZone runat="server" FrameType="None" ID="WebPartZone2" Title="loc:Main">
        <ZoneTemplate>
            <WebPartPages:XsltListViewWebPart runat="server" ViewFlag="" ShowToolbarWithRibbon="True" ViewSelectorFetchAsync="False"
                ...
                <JSLink>~siteCollection/styles/scripts/OvertimeModule/JSLink_OvertimeEmployeeDetail_View.min.js?v=3A09E3D0-DF78-45B9-B6B5-2CAC0DC27CA0</JSLink>
