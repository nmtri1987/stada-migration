...
RBVH.Stada.WebPages.pages.RequestForm.prototype =
    {
        ...
        InitControls: function () {
            ...
            if (that.Settings.IsFormEditable == true) {
                ...
                that.Settings.SupportingDocuments = [];
                $(that.Settings.Controls.SupportingDocumentDeletedItemSelector).each(function () {
                    that.Settings.SupportingDocuments.push($(this).attr('name'));
                });
        ...
        CheckFieldValueChange: function () {
            ...
            var supportingDocumentDeletedItems = [];
            $(that.Settings.Controls.SupportingDocumentDeletedItemSelector).each(function () {
                supportingDocumentDeletedItems.push($(this).attr('name'));
            });
            count += ($(that.Settings.SupportingDocuments).not(supportingDocumentDeletedItems).length === 0 && $(supportingDocumentDeletedItems).not(that.Settings.SupportingDocuments).length === 0) ? 0 : 1;
            ...
            if (that.Settings.IsFormEditable) {
                ...
                if (requestType == "RequestBuyDetails") {
                    for (var i = 0; i < that.Settings.Grid1JsonArray.length; i++) {
                        ...
                        item.Quantity = that.Settings.Grid1JsonArray[i].Quantity;
        ...
        BindRequestBuyDetailsGridColumns: function () {
            ...
            that.Settings.Grid1.Fields = [
                ...
                { name: "Quantity", title: that.Settings.GridResources.GridBuyDetail_Quantity, width: 90, align: "left", type: "text", maxLength: 15 },
        ...
        BindRequestOthersGridColumns: function () {
            ...
            that.Settings.Grid3.Fields = [
                ...
                { name: "Quantity", title: that.Settings.GridResources.GridOthersDetail_Quantity, width: 90, align: "left", type: "text", maxLength: 15 },
