...
{
    public partial class FreightManagementMember : LayoutsPageBase
    {
        ...
        private void CheckCurrentUser()
        {
            ...
            if (Page.Session[SessionKey.IsVehicleOperator] != null)
            {
                bool.TryParse(Page.Session[SessionKey.IsVehicleOperator].ToString(), out this.isVehicleOperator);
            }
            else
            {
                AdditionalEmployeePositionDAL additionalEmployeePositionDAL = new AdditionalEmployeePositionDAL(SPContext.Current.Web.Url);
                this.isVehicleOperator = additionalEmployeePositionDAL.GetAdditionalPosition(currentEmployee.ID, StringConstant.AdditionalEmployeePositionModule.FreightManagement, StringConstant.AdditionalEmployeePositionLevelCode.VehicleOperator);
                Page.Session[SessionKey.IsVehicleOperator] = this.isVehicleOperator;
            }
