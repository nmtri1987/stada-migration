    ...
    public class EmployeeService : IEmployeeService
    {
        ...
        public List<PeoplePickerUser> PostPeoplePickerData(PeoplePickerDataRequest peoplePickerDataRequest)
        {
            ...
            if (peoplePickerDataRequest.EmployeePositions != null)
                employeePositionList.AddRange(peoplePickerDataRequest.EmployeePositions.Select(item => new Biz.Models.EmployeePosition { Code = item.Code, Name = item.Name, PositionName = item.PositionName, VietnameseName = item.VietnameseName }));
