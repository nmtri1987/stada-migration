    ...
    public partial class ResetPassword : LayoutsPageBase
    {
        ...
        protected void FirstLoad()
        {
            ...
            else
            {
                ...
                SPUtility.Redirect(SPContext.Current.Web.Url + StringConstant.PageOverviewURL, SPRedirectFlags.DoNotEndResponse | SPRedirectFlags.Trusted, HttpContext.Current);
            }
        }
