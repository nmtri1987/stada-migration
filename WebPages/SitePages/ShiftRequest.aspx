...
<asp:Content ID="PageHead" ContentPlaceHolderID="PlaceHolderAdditionalPageHead" runat="server">
    ...
    <script type="text/javascript" src="/styles/scripts/ShiftModule/ShiftRequest.min.js?v=CD44ED56-260A-4C8D-A2FE-A3A3FB20FE5C"></script>
</asp:Content>
                    ...
                    <td>
                      ...
                      <div class="form-inline pt10">
                            ...
                            <div class="form-group">
                                ...
                                <img src="/styles/images/excel.png" style="width: 27px; height: 27px; cursor:pointer" id="btnShiftRequestImport"/>
                            </div>
                        </div>
                    </td>
                </tr>
