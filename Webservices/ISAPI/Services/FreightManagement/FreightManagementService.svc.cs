    ...
    public class FreightManagementService : IFreightManagementService
    {
        ...
        public MessageResult InsertFreight(FreightManagementModel freightManagementModel)
        {
            ...
            try
            {
                ...
                Biz.Models.FreightManagement freightManagementEntity = freightManagementModel.ToEntity();

                CommonApproverModel freightManagementApprover = _freightManagementDAL.CreateApprovalList(freightManagementEntity.Department.LookupId, freightManagementEntity.Location.LookupId);
                if (freightManagementApprover != null)
                {
                    if (freightManagementApprover.Approver1 != null)
                        freightManagementEntity.DH = new User() { ID = freightManagementApprover.Approver1.ID, FullName = freightManagementApprover.Approver1.ADAccount.FullName, UserName = freightManagementApprover.Approver1.ADAccount.UserName };

                    if (freightManagementApprover.Approver2 != null)
                        freightManagementEntity.BOD = new User() { ID = freightManagementApprover.Approver2.ID, FullName = freightManagementApprover.Approver2.ADAccount.FullName, UserName = freightManagementApprover.Approver2.ADAccount.UserName };

                    if (freightManagementApprover.Approver3 != null)
                        freightManagementEntity.AdminDept = new User() { ID = freightManagementApprover.Approver3.ID, FullName = freightManagementApprover.Approver3.ADAccount.FullName, UserName = freightManagementApprover.Approver3.ADAccount.UserName };
                }

                freightManagementEntity = _freightManagementDAL.SetDueDate(freightManagementEntity);

                #region Determine status of the request
                if ((freightManagementModel.Id <= 0) || (freightManagementModel.Id > 0 && freightManagementEntity.ApprovalStatus == StringConstant.ApprovalStatus.Rejected))
                {
                    if (freightManagementEntity.Requester.LookupId == freightManagementEntity.DH.ID)
                    {
                        freightManagementEntity.ApprovalStatus = StepStatusList.BODApproval;
                    }
                    else
                    {
                        freightManagementEntity.ApprovalStatus = StepStatusList.DHApproval;
                    }
                    freightManagementEntity.Comment = string.Empty;
                    freightManagementEntity.SecurityNotes = string.Empty;
                    freightManagementEntity.IsFinished = false;
                    freightManagementEntity.HighPriority = false;
                }
                #endregion

                int itemId = _freightManagementDAL.SaveOrUpdate(spWeb, freightManagementEntity);
                ...
                var freightManagement = _freightManagementDAL.GetByID(itemId);
                ...
                {
                    Biz.Models.User assignedTo = null;
                    Biz.Models.User nextAssignedTo = null;
                    if (freightManagementEntity.Requester.LookupId == freightManagementEntity.DH.ID)
                    {
                        assignedTo = freightManagement.BOD;
                    }
                    else
                    {
                        assignedTo = freightManagement.DH;
                    }

                    StepManagementDAL _stepManagementDAL = new StepManagementDAL(spWeb.Url);
                    var nextStep = _stepManagementDAL.GetNextStepManagement(freightManagement.ApprovalStatus, StepModuleList.FreightManagement, freightManagementEntity.Department.LookupId);
                    if (nextStep != null)
                    {
                        var nextAssign = _freightManagementDAL.GetApproverAtStep(freightManagementEntity.Department.LookupId, freightManagementEntity.Location.LookupId, StepModuleList.FreightManagement, nextStep.StepNumber);
                        if (nextAssign != null)
                        {
                            nextAssignedTo = nextAssign.ADAccount;
                        }
                    }

                    _freightManagementDAL.StartWorkFlow(spWeb, freightManagement, assignedTo, nextAssignedTo);
                }
            }
            catch (Exception ex)
            {
        ...
        public MessageResult UpdateFreightVehicle(FreightManagementModel freightManagementModel)
        {
            try
            {
                if (freightManagementModel != null && freightManagementModel.Id > 0)
                {
                    ...
                    {
                        freightManagement.VehicleLookup = LookupItemHelper.ConvertToEntity(freightManagementModel.VehicleLookup);
        ...
        private FreightManagementModel ConvertToModel(Biz.Models.FreightManagement freightManagement)
        {
            ...
            FreightManagementModel freightManagementModel = new FreightManagementModel()
            {
                ...
                Requester = LookupItemHelper.ConvertToModel(freightManagement.Requester),
                Department = LookupItemHelper.ConvertToModel(freightManagement.Department),
                Location = LookupItemHelper.ConvertToModel(freightManagement.Location),
                Bringer = LookupItemHelper.ConvertToModel(freightManagement.Bringer),
                BringerDepartment = LookupItemHelper.ConvertToModel(freightManagement.BringerDepartment),
                BringerLocation = LookupItemHelper.ConvertToModel(freightManagement.BringerLocation),
                ...
                ReceiverDepartmentLookup = LookupItemHelper.ConvertToModel(freightManagement.ReceiverDepartmentLookup),
                ReceiverDepartmentVN = LookupItemHelper.ConvertToModel(freightManagement.ReceiverDepartmentVN),
                ...
                VehicleLookup = LookupItemHelper.ConvertToModel(freightManagement.VehicleLookup),
                VehicleVN = LookupItemHelper.ConvertToModel(freightManagement.VehicleVN),
            ...
            if (freightManagement.DH != null)
            {
                freightManagementModel.DH = new UserModel { FirstName = freightManagement.DH.FirstName, FullName = freightManagement.DH.FullName, ID = freightManagement.DH.ID, IsGroup = freightManagement.DH.IsGroup, LastName = freightManagement.DH.LastName, UserName = freightManagement.DH.UserName };
            }
            if (freightManagement.AdminDept != null)
            {
                freightManagementModel.AdminDept = new UserModel { FirstName = freightManagement.AdminDept.FirstName, FullName = freightManagement.AdminDept.FullName, ID = freightManagement.AdminDept.ID, IsGroup = freightManagement.AdminDept.IsGroup, LastName = freightManagement.AdminDept.LastName, UserName = freightManagement.AdminDept.UserName };
            }
            if (freightManagement.BOD != null)
            {
                freightManagementModel.BOD = new UserModel { FirstName = freightManagement.BOD.FirstName, FullName = freightManagement.BOD.FullName, ID = freightManagement.BOD.ID, IsGroup = freightManagement.BOD.IsGroup, LastName = freightManagement.BOD.LastName, UserName = freightManagement.BOD.UserName };
            }
            if (freightManagement.CreatedBy != null)
            {
                freightManagementModel.CreatedBy = new UserModel { FirstName = freightManagement.CreatedBy.FirstName, FullName = freightManagement.CreatedBy.FullName, ID = freightManagement.CreatedBy.ID, IsGroup = freightManagement.CreatedBy.IsGroup, LastName = freightManagement.CreatedBy.LastName, UserName = freightManagement.CreatedBy.UserName };
            }
            if (freightManagement.ModifiedBy != null)
            {
                freightManagementModel.ModifiedBy = new UserModel { FirstName = freightManagement.ModifiedBy.FirstName, FullName = freightManagement.ModifiedBy.FullName, ID = freightManagement.ModifiedBy.ID, IsGroup = freightManagement.ModifiedBy.IsGroup, LastName = freightManagement.ModifiedBy.LastName, UserName = freightManagement.ModifiedBy.UserName };
            }
        ...
        private FreightDetailsModel ConvertToModel(FreightDetails freightDetails)
        {
            FreightDetailsModel freightDetailsModel = new FreightDetailsModel()
            {
                ...
                FreightManagementID = LookupItemHelper.ConvertToModel(freightDetails.FreightManagementID),
