...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="WorkflowHistoryNewControl.ascx.cs" Inherits="RBVH.Stada.Intranet.WebPages.CONTROLTEMPLATES.RBVH.Stada.Controls.Common.WorkflowHistoryControl" %>
