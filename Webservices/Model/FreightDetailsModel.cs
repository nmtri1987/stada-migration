...
namespace RBVH.Stada.Intranet.Webservices.Model
{
    public class FreightDetailsModel
    {
        ...
        public LookupItemModel FreightManagementID { get; set; }
        ...
        public FreightDetails ToEntity()
        {
            ...
            freightDetails.FreightManagementID = new LookupItem { LookupId = (FreightManagementID != null ? FreightManagementID.LookupId : 0), LookupValue = (FreightManagementID != null ? FreightManagementID.LookupValue : string.Empty) };
