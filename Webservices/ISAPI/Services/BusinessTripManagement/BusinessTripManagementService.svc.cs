    ...
    public class BusinessTripManagementService : IBusinessTripManagementService
    {
        ...
        public MessageResult InsertBusinessTripManagement(BusinessTripManagementModel businessTripManagementModel)
        {
            ...
            try
            {
                ...
                Biz.Models.BusinessTripManagement businessTripManagementEntity = businessTripManagementModel.ToEntity();
                if (businessTripManagementModel.Id <= 0)
                {
                    AdditionalEmployeePositionDAL _additionalEmployeePositionDAL = new AdditionalEmployeePositionDAL(SPContext.Current.Site.Url);
                    if (businessTripManagementModel.Driver == null || (businessTripManagementModel.Driver != null && businessTripManagementModel.Driver.LookupId == 0))
                    {
                        ...
                        {
                            businessTripManagementEntity.Driver = new LookupItem() { LookupId = drivers[0].Employee.LookupId, LookupValue = drivers[0].Employee.LookupValue };
                        }
                    }

                    if (businessTripManagementEntity.Cashier == null || (businessTripManagementEntity.Cashier != null && businessTripManagementEntity.Cashier.LookupId == 0))
                    {
                        ...
                        {
                            businessTripManagementEntity.Cashier = new LookupItem() { LookupId = accountants[0].Employee.LookupId, LookupValue = accountants[0].Employee.LookupValue };
                        }
                    }
                }
                ...
                businessTripManagementEntity = _businessTripManagementDAL.SetDueDate(businessTripManagementEntity, startTripDate);

                #region Determine status of the request
                if (businessTripManagementModel.Id <= 0)
                {
                    if (businessTripManagementEntity.Requester.LookupId == businessTripManagementEntity.DH.ID)
                    {
                        businessTripManagementEntity.ApprovalStatus = StepStatusList.BODApproval;
                    }
                    else
                    {
                        businessTripManagementEntity.ApprovalStatus = StepStatusList.DHApproval;
                    }
                }
                #endregion

                int itemId = _businessTripManagementDAL.SaveOrUpdate(spWeb, businessTripManagementEntity);
                if (itemId > 0)
                {
                ...
                var businessTripManagement = _businessTripManagementDAL.GetByID(itemId);
                if (businessTripManagementModel.Id <= 0 && itemId > 0)
                {
                    ...
                    if (businessTripManagementEntity.Requester.LookupId == businessTripManagementEntity.DH.ID)
                    {
                        assignedTo = businessTripManagementEntity.DirectBOD.ID > 0 ? businessTripManagement.DirectBOD : businessTripManagement.BOD;
                    }
                    else
                    {
                        assignedTo = businessTripManagement.DH;
                    }

                    StepManagementDAL _stepManagementDAL = new StepManagementDAL(spWeb.Url);
                    var nextStep = _stepManagementDAL.GetNextStepManagement(businessTripManagement.ApprovalStatus, StepModuleList.BusinessTripManagement, businessTripManagementEntity.CommonDepartment.LookupId);
                    if (nextStep != null)
                    {
                        var nextAssign = _businessTripManagementDAL.GetApproverAtStep(businessTripManagementEntity.CommonDepartment.LookupId, businessTripManagementEntity.CommonLocation.LookupId, StepModuleList.BusinessTripManagement, nextStep.StepNumber);
                        if (nextAssign != null)
                        {
                            nextAssignedTo = nextAssign.ADAccount;
                        }
                    }
                    _businessTripManagementDAL.StartWorkFlow(spWeb, businessTripManagement, assignedTo, nextAssignedTo);
                }
            }
            catch (Exception ex)
            {
        ...
        private BusinessTripManagementModel ConvertToModel(Biz.Models.BusinessTripManagement businessTripManagement)
        {
            ...
            BusinessTripManagementModel businessTripManagementModel = new BusinessTripManagementModel()
            {
                ...
                Requester = LookupItemHelper.ConvertToModel(businessTripManagement.Requester),
                Department = LookupItemHelper.ConvertToModel(businessTripManagement.CommonDepartment),
                Location = LookupItemHelper.ConvertToModel(businessTripManagement.CommonLocation),
                ...
                Driver = LookupItemHelper.ConvertToModel(businessTripManagement.Driver),
                Cashier = LookupItemHelper.ConvertToModel(businessTripManagement.Cashier),
            ...
            if (businessTripManagement.DH != null)
            {
                businessTripManagementModel.DH = new UserModel { FirstName = businessTripManagement.DH.FirstName, FullName = businessTripManagement.DH.FullName, ID = businessTripManagement.DH.ID, IsGroup = businessTripManagement.DH.IsGroup, LastName = businessTripManagement.DH.LastName, UserName = businessTripManagement.DH.UserName };
            }
            if (businessTripManagement.DirectBOD != null)
            {
                businessTripManagementModel.DirectBOD = new UserModel { FirstName = businessTripManagement.DirectBOD.FirstName, FullName = businessTripManagement.DirectBOD.FullName, ID = businessTripManagement.DirectBOD.ID, IsGroup = businessTripManagement.DirectBOD.IsGroup, LastName = businessTripManagement.DirectBOD.LastName, UserName = businessTripManagement.DirectBOD.UserName };
            }
            if (businessTripManagement.BOD != null)
            {
                businessTripManagementModel.BOD = new UserModel { FirstName = businessTripManagement.BOD.FirstName, FullName = businessTripManagement.BOD.FullName, ID = businessTripManagement.BOD.ID, IsGroup = businessTripManagement.BOD.IsGroup, LastName = businessTripManagement.BOD.LastName, UserName = businessTripManagement.BOD.UserName };
            }
            if (businessTripManagement.AdminDept != null)
            {
                businessTripManagementModel.AdminDept = new UserModel { FirstName = businessTripManagement.AdminDept.FirstName, FullName = businessTripManagement.AdminDept.FullName, ID = businessTripManagement.AdminDept.ID, IsGroup = businessTripManagement.AdminDept.IsGroup, LastName = businessTripManagement.AdminDept.LastName, UserName = businessTripManagement.AdminDept.UserName };
            }
            if (businessTripManagement.CreatedBy != null)
            {
                businessTripManagementModel.CreatedBy = new UserModel { FirstName = businessTripManagement.CreatedBy.FirstName, FullName = businessTripManagement.CreatedBy.FullName, ID = businessTripManagement.CreatedBy.ID, IsGroup = businessTripManagement.CreatedBy.IsGroup, LastName = businessTripManagement.CreatedBy.LastName, UserName = businessTripManagement.CreatedBy.UserName };
            }
            if (businessTripManagement.ModifiedBy != null)
            {
                businessTripManagementModel.ModifiedBy = new UserModel { FirstName = businessTripManagement.ModifiedBy.FirstName, FullName = businessTripManagement.ModifiedBy.FullName, ID = businessTripManagement.ModifiedBy.ID, IsGroup = businessTripManagement.ModifiedBy.IsGroup, LastName = businessTripManagement.ModifiedBy.LastName, UserName = businessTripManagement.ModifiedBy.UserName };
            }
        ...
        private BusinessTripEmployeeModel ConvertToModel(BusinessTripEmployeeDetail businessTripEmployeeDetail, string departmentName = "")
        {
            BusinessTripEmployeeModel businessTripEmployeeModel = new BusinessTripEmployeeModel()
            {
                ...
                BusinessTripManagementID = LookupItemHelper.ConvertToModel(businessTripEmployeeDetail.BusinessTripManagementID),
        ...
        private BusinessTripScheduleModel ConvertToModel(BusinessTripSchedule businessTripSchedule)
        {
            BusinessTripScheduleModel businessTripScheduleModel = new BusinessTripScheduleModel()
            {
                ...
                BusinessTripManagementID = LookupItemHelper.ConvertToModel(businessTripSchedule.BusinessTripManagementID),
