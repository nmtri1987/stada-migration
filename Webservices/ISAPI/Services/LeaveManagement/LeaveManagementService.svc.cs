    ...
    public class LeaveManagementService : ILeaveManagementService
    {
        ...
        public MessageResult InsertLeaveManagement(LeaveManagementModel leaveManagementModel)
        {
            ...
            if (leaveManagementModel != null)
            {
                try
                {
                    ...
                    if (leaveManagementEntity.ID <= 0)
                    {
                        if (leaveManagementEntity.TLE != null && leaveManagementEntity.TLE.ID > 0)
                        {
                            EmployeeInfo approver = _employeeInfoDAL.GetByADAccount(leaveManagementEntity.TLE.UserName);
                            if (approver.EmployeePosition.LookupId == (int)StringConstant.EmployeePosition.TeamLeader)
                            {
                                leaveManagementEntity.ApprovalStatus = StepStatusList.TLEApproval;
                            }
                            else if (approver.EmployeePosition.LookupId == (int)StringConstant.EmployeePosition.ShiftLeader)
                            {
                                leaveManagementEntity.ApprovalStatus = StepStatusList.SLDApproval;
                            }
                        }
                        else if (leaveManagementEntity.DH != null && leaveManagementEntity.DH.ID > 0)
                        {
                            leaveManagementEntity.ApprovalStatus = StepStatusList.DHApproval;
                        }
                        else if (leaveManagementEntity.BOD != null && leaveManagementEntity.BOD.ID > 0)
                        {
                            leaveManagementEntity.ApprovalStatus = StepStatusList.BODApproval;
                        }
                    }
        ...
        public LeaveResult GetAllLeaveInfo(string employeeID, string fromDate, string toDate)
        {
            ...
            try
            {
                ...
                _leaveManagementDAL.CheckOverlap(leaveResult, employeeInfo, shiftTimeCollection, currentUser.ID, isRequestFor);
        ...
        public List<LeaveInfo> GetLeavesInRange(string employeeID, string departmentID, string locationID, string fromDate, string toDate)
        {
            List<LeaveInfo> ret = new List<LeaveInfo>();
            try
            {
                var empId = Convert.ToInt32(employeeID);
                var departmentId = Convert.ToInt32(departmentID);
        ...
        private LeaveManagementModel ConvertToModel(Biz.Models.LeaveManagement entity)
        {
            ...
            {
                Id = entity.ID,
                Requester = LookupItemHelper.ConvertToModel(entity.Requester),
                RequestFor = LookupItemHelper.ConvertToModel(entity.RequestFor),
                Department = LookupItemHelper.ConvertToModel(entity.Department),
                Location = LookupItemHelper.ConvertToModel(entity.Location),
                ...
                TransferworkTo = LookupItemHelper.ConvertToModel(entity.TransferworkTo),
            ...
            if (entity.TLE != null)
            {
                leaveManagementModel.TLE = new UserModel { FirstName = entity.TLE.FirstName, FullName = entity.TLE.FullName, ID = entity.TLE.ID, IsGroup = entity.TLE.IsGroup, LastName = entity.TLE.LastName, UserName = entity.TLE.UserName };
            }
            if (entity.DH != null)
            {
                leaveManagementModel.DH = new UserModel { FirstName = entity.DH.FirstName, FullName = entity.DH.FullName, ID = entity.DH.ID, IsGroup = entity.DH.IsGroup, LastName = entity.DH.LastName, UserName = entity.DH.UserName };
            }
            if (entity.BOD != null)
            {
                leaveManagementModel.BOD = new UserModel { FirstName = entity.BOD.FirstName, FullName = entity.BOD.FullName, ID = entity.BOD.ID, IsGroup = entity.BOD.IsGroup, LastName = entity.BOD.LastName, UserName = entity.BOD.UserName };
            }

            leaveManagementModel.Approver = leaveManagementModel.TLE ?? leaveManagementModel.DH ?? leaveManagementModel.BOD;

            if (entity.AdditionalUser != null && entity.AdditionalUser.Count > 0)
            {
                foreach (var addUser in entity.AdditionalUser)
                {
                    leaveManagementModel.AdditionalUser.Add(new UserModel { FirstName = addUser.FirstName, FullName = addUser.FullName, ID = addUser.ID, IsGroup = addUser.IsGroup, LastName = addUser.LastName, UserName = addUser.UserName });
                }
            }

            if (entity.CreatedBy != null)
            {
                leaveManagementModel.CreatedBy = new UserModel { FirstName = entity.CreatedBy.FirstName, FullName = entity.CreatedBy.FullName, ID = entity.CreatedBy.ID, IsGroup = entity.CreatedBy.IsGroup, LastName = entity.CreatedBy.LastName, UserName = entity.CreatedBy.UserName };
            }
            if (entity.ModifiedBy != null)
            {
                leaveManagementModel.ModifiedBy = new UserModel { FirstName = entity.ModifiedBy.FirstName, FullName = entity.ModifiedBy.FullName, ID = entity.ModifiedBy.ID, IsGroup = entity.ModifiedBy.IsGroup, LastName = entity.ModifiedBy.LastName, UserName = entity.ModifiedBy.UserName };
            }
