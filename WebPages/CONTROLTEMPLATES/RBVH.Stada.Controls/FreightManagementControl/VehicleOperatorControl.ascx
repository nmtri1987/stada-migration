...
<script type="text/javascript" src="/styles/scripts/FreightModule/FreightByDepartment.min.js?v=3A09E3D0-DF78-45B9-B6B5-2CAC0DC27CA0"></script>
            ...
            <div class="form-inline pt10">
                ...
                <div class="form-group">
                    <div class="input-append  date inner-addon right-addon txtCalendar" id="dpMonths" data-date="102/2012" data-date-format="mm/yyyy" data-date-viewmode="years" data-date-minviewmode="months" style="width: 150px;">
                        ...
                        <img src="/styles/images/excel.png" style="width: 27px; height: 27px; cursor:pointer; position: absolute; left: 160px; top: 4px;" id="img-export-excel"/>
                    </div>
                </div>
            </div>
        </td>
