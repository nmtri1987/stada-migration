(function () {
    ...
    function CustomItem(ctx) {
        ...
        tr = "<tr>" + Requester + Department + HoursPerDay + date + From + To + Reason + statusVal + viewDetail + "</tr>";
        return tr;
    }
    ...
    function approval_Task(itemId, currentStatus, employeeId) {
        ...
        if (NotOvertimeNotOvertimeApprovalTaskConfig.ApprovalStatus && NotOvertimeNotOvertimeApprovalTaskConfig.ApprovalStatus.toLowerCase() != 'cancelled') {
