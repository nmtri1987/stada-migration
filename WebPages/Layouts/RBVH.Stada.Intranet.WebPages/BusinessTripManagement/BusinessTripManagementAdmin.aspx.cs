...
{
    public partial class BusinessTripManagementAdmin : LayoutsPageBase
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (Page.Session[SessionKey.IsAdminOfHRDepartment] != null)
            {
                bool isAdminOfHRDepartment;
                bool.TryParse(Page.Session[SessionKey.IsAdminOfHRDepartment].ToString(), out isAdminOfHRDepartment);
                this.IsAdminOfHRDepartment = isAdminOfHRDepartment;
            }
            else
            {
                var isAdminOfHRDepartment = UserPermission.IsAdminOfHRDepartment;
                Page.Session[SessionKey.IsAdminOfHRDepartment] = isAdminOfHRDepartment;
                this.IsAdminOfHRDepartment = isAdminOfHRDepartment;
            }
