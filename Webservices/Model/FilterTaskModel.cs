   ...
   public class FilterTaskModel
    {
        ...
        public static FilterTaskModel FromDTO(FilterTask item)
        {
            return new FilterTaskModel
            {
                ...
                AssignedToId = item.AssignedTo != null ? item.AssignedTo.LookupId : 0,
                AssignedToName = item.AssignedTo != null ? item.AssignedTo.LookupValue : string.Empty,
                ...
                DueDateTime = item.DueDate == DateTime.MinValue ? null : item.DueDate
            };
        }
    }
}
