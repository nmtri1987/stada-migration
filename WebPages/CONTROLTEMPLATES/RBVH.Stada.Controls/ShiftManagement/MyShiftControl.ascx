...
<%--<script type="text/javascript" src="/styles/scripts/ShiftModule/MyShift.min.js?v=CD44ED56-260A-4C8D-A2FE-A3A3FB20FE5C"></script>--%>
<style>
               ...
               <WebPartPages:WebPartZone runat="server" FrameType="None" ID="MyShiftWebPartZone" Title="loc:Main">
                  <ZoneTemplate>
                     <WebPartPages:XsltListViewWebPart
                        ...
                        <JSLink>~sitecollection/styles/scripts/ShiftModule/JSLink_Shift.min.js?v=CD44ED56-260A-4C8D-A2FE-A3A3FB20FE5C</JSLink>
                     </WebPartPages:XsltListViewWebPart>
                  </ZoneTemplate>
