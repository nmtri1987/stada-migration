...
<asp:Content ID="PageHead" ContentPlaceHolderID="PlaceHolderAdditionalPageHead" runat="server">
    ...
    <link type="text/css" rel="stylesheet" href="/styles/css/LeaveModule/default.min.css?v=CD44ED56-260A-4C8D-A2FE-A3A3FB20FE5C" />
    <script type="text/javascript" src="/styles/libs/select2/select2.min.js"></script>
    <script type="text/javascript" src="/styles/scripts/LeaveModule/LeaveRequest.min.js?v=CD44ED56-260A-4C8D-A2FE-A3A3FB20FE5C"></script>
    <style>
