...
RBVH.Stada.WebPages.pages.OvertimeRequest.prototype = {
    ...
    RegisterEvents: function () {
        ...
        $(document).on('click', 'a.viewDetail', function () {
            ...
            var ModalDialogOptions = { url: dialogUrl, width: 800, height: 400, showClose: true, allowMaximize: false, title: that.Settings.ViewDetail };
    ...
    PopulateGrid: function () {
        ...
        $(that.Settings.GridOvertimeRequestControlSelector).jsGrid({
            ...
            onItemInserted: function (args) {
                ...
                setTimeout(function () {
                    $(that.Settings.RegisteredEmployeeList).each(function () {
                        var employeeName = this.FullName.split('_')[0];
                        // Highlight invalid rows
                        $('.jsgrid-grid-body td:contains(' + employeeName + ')').parent('tr').children('td, th').addClass('invalid-row');
                    });
                }, 100)
            },
                ...
                if (typeof OnSaveData == 'function') {
                    ...
                    $(newEmployeeList).each(function () {
                        ...
                        if (existed == true) {
                            ...
                            $('.jsgrid-grid-body td:contains(' + employeeName + ')').parent('tr').children('td, th').removeClass('invalid-row');
                    });
